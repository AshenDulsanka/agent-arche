...
The issue tracker should have been provided to you — run `/project-startup` if `docs/agents/issue-tracker.md` is missing.
...
3. A PRD/spec file under `docs/`, `specs/`, or the repo-local issue/spec path configured in `docs/agents/issue-tracker.md`, matching the branch name or feature.
