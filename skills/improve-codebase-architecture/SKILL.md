...
Explore the codebase directly. If the user or active environment explicitly allows sub-agents, independent areas may be delegated; the workflow must still work without them. Don't follow rigid heuristics — explore organically and note where you experience friction:
...
Keep domain documentation current as decisions crystallize, following `docs/agents/domain.md` when present:
