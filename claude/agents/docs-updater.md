...
The project memory vault lives at `.claude/memory/`. You **read** memory notes to inform documentation updates — you do not write memory notes yourself.

### Before Updating Docs
- Read `.claude/memory/_MOC.md` for the full picture of what changed this session
