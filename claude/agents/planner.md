...
2. `.claude/skills/grill-me/SKILL.md` — interrogate before any plan (mandatory, no exceptions)
3. `.claude/skills/to-prd/SKILL.md` — synthesize shared understanding into PRD
4. `.claude/skills/to-issues/SKILL.md` — break PRD into vertical-slice GitHub issues
