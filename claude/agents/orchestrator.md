...
1. `.claude/skills/caveman/SKILL.md` — load and apply before first response, active all session
2. `.claude/skills/project-startup/SKILL.md` — first-time project setup only (see Startup Flow)
