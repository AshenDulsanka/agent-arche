...
On start: read `.claude/memory/_MOC.md` + `learnings/` for testing gotchas, flaky selectors, and setup quirks. Do not write to memory — include a **Handoff** block in output for Docs-updater.
