...
Always load:
- `.github/skills/caveman/SKILL.md` — load and apply before first response
- `.github/skills/design/SKILL.md` — consolidated design workflow, subflow routing, quality guardrails, review, motion, performance, style modes, and full-output support
