...
2. `.claude/skills/design-intelligence/SKILL.md` — product-fit, audience, tone, density, and motion context (always loaded)
3. `.claude/skills/ui-audit/SKILL.md` — structured scoring across 5 quality dimensions (always loaded)
4. `.claude/skills/critique/SKILL.md` — deep heuristic evaluation, Nielsen /40, cognitive load, personas (always loaded)
