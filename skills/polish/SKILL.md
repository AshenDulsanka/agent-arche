...
argument-hint: "[component or page to polish]"
user-invocable: true
---

## MANDATORY PREPARATION

Read `.github/skills/impeccable/SKILL.md` first — it contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding — if no design context exists yet, you MUST run the impeccable teach flow first. Additionally gather: quality bar (MVP vs flagship).
