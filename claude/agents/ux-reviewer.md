...
2. `.claude/skills/ui-audit/SKILL.md` — structured scoring across 5 quality dimensions (always loaded)
3. `.claude/skills/critique/SKILL.md` — deep heuristic evaluation, Nielsen /40, cognitive load, personas (always loaded)
