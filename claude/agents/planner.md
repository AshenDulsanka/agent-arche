...
2. `.claude/skills/grill-me/SKILL.md` — use for projects that have not started yet
3. `.claude/skills/grill-with-docs/SKILL.md` — use for projects with existing code or domain docs
4. `.claude/skills/create-prd/SKILL.md` — create the PRD
5. `.claude/skills/create-epics-and-stories/SKILL.md` — break PRD into epics and stories
6. `.claude/skills/project-startup/SKILL.md` — load if `docs/agents/` context is missing for engineering skills
...
On start: read `.claude/memory/_MOC.md` + `decisions/` for relevant ADRs — avoid re-deciding settled questions. Do not write to memory — include a **Handoff** block in output for Docs-updater.
