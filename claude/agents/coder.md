...
On start: read `memory/_MOC.md` + `patterns/` + `decisions/` for established patterns and constraints. Do not write to memory — include a **Handoff** block in output for Docs-updater.
