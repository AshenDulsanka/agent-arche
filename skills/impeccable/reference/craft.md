...
Run the shape skill, passing along whatever feature description the user provided.
...
If the user has already run the shape skill and has a confirmed design brief, skip this step and use the existing brief.
