...
3. Write the spec using the template below. Show the draft before creating or updating anything in an external tracker. After the user approves publication, use the configured workflow in `docs/agents/issue-tracker.md` and apply the configured `ready-for-agent` label.
