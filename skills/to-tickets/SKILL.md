...
Publish only after the user approves the breakdown. **How** depends on the tracker `project-startup` configured — the tickets are the same either way, only the shape of the blocking edges changes:
