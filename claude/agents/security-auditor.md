...
On start: read `memory/_MOC.md` + `decisions/` + `learnings/` for prior security decisions and known vulnerability patterns. Do not write to memory — include a **Handoff** block in output for Docs-updater.
